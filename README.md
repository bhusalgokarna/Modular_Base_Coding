...
['Hour', 'DayOfWeek', 'BuiltUpArea', 'CollisionType', 'LightCondition',
       'RoadType', 'Municipality', 'District', 'Province', 'Region',
       'Accident', 'AccidentsWithFatalities', 'AccidentsWithFatalities30Days',
       'AccidentsWithMinorInjuries', 'AccidentsWithSeriousInjuries',
       'AccidentsWithSlightInjuries', 'Year', 'Month', 'Day_of_Month'],
